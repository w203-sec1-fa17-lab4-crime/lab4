...
None of the explantory variables are perfectly correlated, and the VIFs are low (i.e. less than 10), so there is no perfect multicollinearity of the independent variables.
