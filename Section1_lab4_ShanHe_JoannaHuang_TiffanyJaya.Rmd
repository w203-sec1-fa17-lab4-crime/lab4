...
Furthermore, it does not appear that the outliers have undue influence on the model fit. Based on the residual vs leverage plot, the oultiers have considerable leverage on the regression but none exceeds a Cook's distance of 1. 
