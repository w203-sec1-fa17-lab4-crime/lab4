...
There are three types of bias that consitutes the endogeneity bias: omitted variable bias, reverse causality, and measurement error which can confound the results of our analysis. 

In Model 1, we have discussed the potential issue of omitted variable bias by deciding not to include $probconv$ and $probsen$ variables due to their outliers. 
