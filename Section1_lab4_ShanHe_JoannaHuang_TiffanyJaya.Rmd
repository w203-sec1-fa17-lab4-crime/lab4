...
In Model 3, we are going to include more variables from the dataset to try to control for more effects the other variables have on our dependent variable. Although this model might introduce many noises as it becomes over-specified, it will be able to explain more of the variances in the dependent variable than the previous models. 
