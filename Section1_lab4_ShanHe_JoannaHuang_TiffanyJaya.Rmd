...
```
Note that although we don't have any counties that are both in west and central, as expected, we see some counties that are neither in west or central. In order to consider the effect on different regions, we will need to use both indicator variables in our model. 
